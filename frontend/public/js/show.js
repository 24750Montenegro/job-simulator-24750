...
const LABELS = ["Nombre", "Descripción", "Categoría", "Stock", "Precio", "Disponible"];
const KEYS   = ["nombre", "descripcion", "categoria", "stock", "precio", "disponible"];
    ...
    document.getElementById("card").innerHTML = `
      <div class="flex items-start justify-between mb-8">
        <div>
          ...
          <h1 class="text-2xl font-semibold">${r.nombre}</h1>
        </div>
      </div>
